...
final FILE_INTERPRET_DIR = Directory(
  '/storage/emulated/0/SuChat/file_interpret',
);

/// 智能对话和多聊中对话语音文件目录
final CHAT_AUDIO_DIR = Directory('/storage/emulated/0/SuChat/chat_audio');

/// 所有的文生图、图生图都保存在同一个位置
final LLM_IG_DIR = Directory('/storage/emulated/0/SuChat/image_generation');

///  新版本的文生图(2025-02-18保存在系统的pictures目录下photo_manager扫不到)
final LLM_IG_DIR_V2 = Directory(
  '/storage/emulated/0/SuChat/brief_image_generation',
);

/// 所有的文生视频都保存在同一个位置
final LLM_VG_DIR = Directory('/storage/emulated/0/SuChat/video_generation');

/// 所有的视频都保存在同一个位置
final LLM_VG_DIR_V2 = Directory(
  '/storage/emulated/0/SuChat/brief_video_generation',
);

/// 一般性质的文件下载的位置
final DL_DIR = Directory('/storage/emulated/0/SuChat/download');
