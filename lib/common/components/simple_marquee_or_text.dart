  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        // 注意，如果是builder的约束，默认为设备的总宽度(测试机为360)，不是全宽跑马灯的话宽度要自定，才能得到准确的行数
        // tp.layout(maxWidth: widget.width ?? 300); // 和下面的sizedbox宽度一致
        ...
        var showWidth =
            widget.width ??
            (constraints.minWidth > 50 ? constraints.minWidth : 300);
