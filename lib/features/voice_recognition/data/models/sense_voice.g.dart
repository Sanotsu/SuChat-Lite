...
SenseVoiceJROutput _$SenseVoiceJROutputFromJson(Map<String, dynamic> json) =>
    SenseVoiceJROutput(
      ...
      (json['results'] as List<dynamic>?)
          ?.map(
            (e) => SenseVoiceJROutputResult.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
...
SenseVoiceJRUsage _$SenseVoiceJRUsageFromJson(Map<String, dynamic> json) =>
    SenseVoiceJRUsage((json['duration'] as num).toInt());
...
SenseVoiceRRProperty _$SenseVoiceRRPropertyFromJson(
  ...
  (json['channels'] as List<dynamic>?)?.map((e) => (e as num).toInt()).toList(),
...
Map<String, dynamic> _$SenseVoiceRRPropertyToJson(
  ...
  'original_duration_in_milliseconds': instance.originalDurationInMilliseconds,
};
...
SenseVoiceRRTranscript _$SenseVoiceRRTranscriptFromJson(
  ...
  (json['sentences'] as List<dynamic>)
      .map(
        (e) =>
            SenseVoiceRRTranscriptSentence.fromJson(e as Map<String, dynamic>),
      )
      .toList(),
);
...
Map<String, dynamic> _$SenseVoiceRRTranscriptToJson(
  ...
  'content_duration_in_milliseconds': instance.contentDurationInMilliseconds,
  'text': instance.text,
...
SenseVoiceRRTranscriptSentence _$SenseVoiceRRTranscriptSentenceFromJson(
  ...
  (json['words'] as List<dynamic>?)
      ?.map(
        (e) => SenseVoiceRRTranscriptSentenceWord.fromJson(
