...
USDAFoodItem _$USDAFoodItemFromJson(Map<String, dynamic> json) => USDAFoodItem(
  ...
  finalFoodInputFoods: (json['finalFoodInputFoods'] as List<dynamic>?)
      ?.map((e) => USDAFinalFoodInputFood.fromJson(e as Map<String, dynamic>))
      .toList(),
  foodAttributeTypes: (json['foodAttributeTypes'] as List<dynamic>?)
      ?.map((e) => USDAFoodAttributeType.fromJson(e as Map<String, dynamic>))
      .toList(),
...
Map<String, dynamic> _$USDAFoodItemToJson(USDAFoodItem instance) =>
    <String, dynamic>{
      ...
      'finalFoodInputFoods': instance.finalFoodInputFoods
          ?.map((e) => e.toJson())
          .toList(),
      'foodMeasures': instance.foodMeasures?.map((e) => e.toJson()).toList(),
      'foodAttributeTypes': instance.foodAttributeTypes
          ?.map((e) => e.toJson())
          .toList(),
...
Map<String, dynamic> _$USDAFoodNutrientToJson(USDAFoodNutrient instance) =>
    <String, dynamic>{
      ...
      'nutrientAnalysisDetails': instance.nutrientAnalysisDetails
          ?.map((e) => e.toJson())
          .toList(),
...
USDANutrientAnalysisDetail _$USDANutrientAnalysisDetailFromJson(
  ...
  nutrientAcquisitionDetails:
      (json['nutrientAcquisitionDetails'] as List<dynamic>?)
          ?.map(
            (e) => USDANutrientAcquisitionDetail.fromJson(
  ...
  labMethodOriginalDescription: json['labMethodOriginalDescription'] as String?,
...
Map<String, dynamic> _$USDANutrientAnalysisDetailToJson(
  ...
  'nutrientId': instance.nutrientId,
  'nutrientAcquisitionDetails': instance.nutrientAcquisitionDetails
      ?.map((e) => e.toJson())
      .toList(),
  'amount': instance.amount,
...
USDAWweiaFoodCategory _$USDAWweiaFoodCategoryFromJson(
  ...
  wweiaFoodCategoryDescription: json['wweiaFoodCategoryDescription'] as String?,
...
Map<String, dynamic> _$USDAFoodAttributeTypeToJson(
  ...
  'description': instance.description,
  'id': instance.id,
  'foodAttributes': instance.foodAttributes?.map((e) => e.toJson()).toList(),
};
...
USDALabelNutrient _$USDALabelNutrientFromJson(
  Map<String, dynamic> json,
) => USDALabelNutrient(
  fat: json['fat'] == null
      ? null
  ...
  saturatedFat: json['saturatedFat'] == null
      ? null
      : NutrientValue.fromJson(json['saturatedFat'] as Map<String, dynamic>),
  ...
  carbohydrates: json['carbohydrates'] == null
      ? null
      : NutrientValue.fromJson(json['carbohydrates'] as Map<String, dynamic>),
...
NutrientValue _$NutrientValueFromJson(Map<String, dynamic> json) =>
    NutrientValue((json['value'] as num).toDouble());
