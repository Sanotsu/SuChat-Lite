...
USDASearchResultResp _$USDASearchResultRespFromJson(
  ...
  (json['pageList'] as List<dynamic>).map((e) => (e as num).toInt()).toList(),
...
USDAError _$USDAErrorFromJson(Map<String, dynamic> json) =>
    USDAError(json['code'] as String, json['message'] as String);
