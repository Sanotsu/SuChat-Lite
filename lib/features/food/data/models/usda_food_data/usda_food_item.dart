...
class USDAFoodNutrient {
  ...
  USDAFoodNutrient.list(this.number, this.name, this.amount, this.unitName);
...
class USDAFoodNutrientDerivation {
  ...
  USDAFoodNutrientDerivation(this.id, this.code, this.description);
...
class USDAMeasureUnit {
  ...
  USDAMeasureUnit({this.id, this.name, this.abbreviation});
...
class USDAFoodAttribute {
  ...
  USDAFoodAttribute({this.value, this.name, this.id});
