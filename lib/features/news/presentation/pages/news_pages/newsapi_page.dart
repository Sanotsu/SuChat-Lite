...
import '../../../data/models/news_api_resp.dart';
...
class _NewsApiPageState extends BaseNewsPageState<NewsApiPage, NewsApiArticle> {
  // 获取分类
  @override
  ...
  Future<void> fetchNewsData({bool isRefresh = false}) async {
    ...
    try {
      ...
      NewsApiResp rst;
      if (query.isNotEmpty) {
        rst = await newsApiManager.getNewsapiList(
          query: query,
          type: "everything",
          pageSize: pageSize,
          page: currentPage,
