...
part of 'readhub_resp.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ReadhubResp _$ReadhubRespFromJson(Map<String, dynamic> json) => ReadhubResp(
  ...
  items: (json['items'] as List<dynamic>?)
      ?.map((e) => ReadhubItem.fromJson(e as Map<String, dynamic>))
      .toList(),
);

Map<String, dynamic> _$ReadhubRespToJson(ReadhubResp instance) =>
    <String, dynamic>{
...
Map<String, dynamic> _$ReadhubItemToJson(ReadhubItem instance) =>
    <String, dynamic>{
      'uid': instance.uid,
...
ReadhubUseful _$ReadhubUsefulFromJson(Map<String, dynamic> json) =>
    ReadhubUseful((json['count'] as num?)?.toInt(), json['topicId'] as String?);

Map<String, dynamic> _$ReadhubUsefulToJson(ReadhubUseful instance) =>
    <String, dynamic>{'count': instance.count, 'topicId': instance.topicId};
