...
part of 'momoyu_resp.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

MomoyuResp<T> _$MomoyuRespFromJson<T>(
...
Map<String, dynamic> _$MomoyuRespToJson<T>(
  MomoyuResp<T> instance,
...
ListWithT<T> _$ListWithTFromJson<T>(
  Map<String, dynamic> json,
  T Function(Object? json) fromJsonT,
) => ListWithT<T>((json['list'] as List<dynamic>?)?.map(fromJsonT).toList());
