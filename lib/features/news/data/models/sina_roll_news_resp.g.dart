...
SinaRNImage _$SinaRNImageFromJson(Map<String, dynamic> json) =>
    SinaRNImage(u: json['u'] as String?, w: json['w'], h: json['h']);

Map<String, dynamic> _$SinaRNImageToJson(SinaRNImage instance) =>
    <String, dynamic>{'u': instance.u, 'w': instance.w, 'h': instance.h};
