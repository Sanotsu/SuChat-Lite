...
import '../../../data/models/jikan/jikan_related_character_resp.dart';
import '../../../data/models/jikan/jikan_statistic.dart';
...
class _MALItemDetailState extends State<MALItemDetail> {
  ...
  // 查询图片
  Future<void> queryMALPictures() async {
  ...
  /// 查询角色
  Future<void> queryMALCharacters() async {
  ...
  Expanded _buildCollectSize(String label) {
    return Expanded(
  ...
  Widget buildPictureArea() {
    ...
    return isPictureLoading
        ...
        : Column(
            ...
            children: [buildTitleText("图片集"), genGrid()],
          );
  }
            ...
            list: malCharacterList
                .map(
                  (e) => {
                    ...
                    "data": e.character,
                    // 类型要为角色
                    "type": CusLabel(cnLabel: "角色", value: MALType.characters),
                  },
                )
                .toList(),
