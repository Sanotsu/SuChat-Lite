...
import '../../../data/datasources/waifu_pic/index.dart';
...
""";
  ...
  Future<void> getRandomWaifuPics() async {
    List<String> fact = [];
              ...
              children: [
                Padding(
                  ...
                  child: FutureBuilder<Directory>(
                    future: getDioDownloadDir(),
                    builder: (context, snapshot) {
                      if (!snapshot.hasData) return const SizedBox.shrink();
                      return buildNetworkImageViewGrid(
                        context,
                        waifuImages,
                        crossAxisCount:
