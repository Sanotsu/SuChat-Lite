...
JKData _$JKDataFromJson(Map<String, dynamic> json) =>
    JKData(
...
Map<String, dynamic> _$JKDataToJson(JKData instance) => <String, dynamic>{
  ...
  'serializations': instance.serializations?.map((e) => e.toJson()).toList(),
...
JKTitle _$JKTitleFromJson(Map<String, dynamic> json) =>
    JKTitle(type: json['type'] as String?, title: json['title'] as String?);
