...
/// 2024-09-19 暂时只关注这4个接口(MAL)，已经有很多第三方客户端了，我就只弄自己感兴趣的部分
...
class JikanResp {
  ...
  JikanResp(this.data, {this.pagination});
...
class JKPaginationItem {
  ...
  JKPaginationItem(this.count, this.total, this.perPage);
...
class JKJpg {
  ...
  JKJpg({this.imageUrl, this.smallImageUrl, this.largeImageUrl});
...
class JKWebp {
  ...
  JKWebp({this.imageUrl, this.smallImageUrl, this.largeImageUrl});
...
class JKTrailer {
  ...
  JKTrailer({this.youtubeId, this.url, this.embedUrl, this.images});
...
class JKAired {
  ...
  JKAired({this.from, this.to, this.prop, this.string});
...
class JKDate {
  ...
  JKDate(this.day, this.month, this.year);
...
class JKBroadcast {
  ...
  JKBroadcast({this.day, this.time, this.timezone, this.string});
...
class JKCusItem {
  ...
  JKCusItem({this.malId, this.type, this.name, this.url});
...
class JKPublished {
  ...
  JKPublished({this.from, this.to, this.prop, this.string});
...
class JKRelation {
  ...
  JKRelation(this.relation, this.entry);
...
class JKTheme {
  ...
  JKTheme({this.openings, this.endings});
...
class JKOuterAnime {
  ...
  JKOuterAnime({this.role, this.position, this.anime});
...
class JKInnerItem {
  ...
  JKInnerItem({this.malId, this.url, this.images, this.title, this.name});
...
class JikanSeasonResp {
  ...
  JikanSeasonResp(this.pagination, this.data);
...
class JKSeasonPagination {
  ...
  JKSeasonPagination(this.lastVisiblePage, this.hasNextPage);
...
class JKSeason {
  ...
  JKSeason(this.year, this.seasons);
