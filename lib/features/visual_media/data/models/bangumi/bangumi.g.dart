...
BGMFilter _$BGMFilterFromJson(Map<String, dynamic> json) => BGMFilter(
  ...
  airDate: (json['air_date'] as List<dynamic>?)
      ?.map((e) => e as String)
      .toList(),
  rating: (json['rating'] as List<dynamic>?)?.map((e) => e as String).toList(),
...
BGMSubject _$BGMSubjectFromJson(Map<String, dynamic> json) => BGMSubject(
  ...
  collection: json['collection'] == null
      ? null
      : BGMLargeCollection.fromJson(json['collection'] as Map<String, dynamic>),
...
BGMInfobox _$BGMInfoboxFromJson(Map<String, dynamic> json) =>
    BGMInfobox(key: json['key'] as String?, value: json['value']);
