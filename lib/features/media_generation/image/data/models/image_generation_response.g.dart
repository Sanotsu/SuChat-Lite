...
CusUnifiedImageGenResp _$CusUnifiedImageGenRespFromJson(
  ...
  images: (json['images'] as List<dynamic>?)
      ?.map((e) => ImageGenerationResult.fromJson(e as Map<String, dynamic>))
      .toList(),
...
AliyunWanxV2Resp _$AliyunWanxV2RespFromJson(Map<String, dynamic> json) =>
    AliyunWanxV2Resp(
      requestId: json['request_id'] as String,
      output: AliyunWanxV2Output.fromJson(
...
AliyunWanxV2Usage _$AliyunWanxV2UsageFromJson(Map<String, dynamic> json) =>
    AliyunWanxV2Usage((json['image_count'] as num).toInt());

Map<String, dynamic> _$AliyunWanxV2UsageToJson(AliyunWanxV2Usage instance) =>
    <String, dynamic>{'image_count': instance.imageCount};
