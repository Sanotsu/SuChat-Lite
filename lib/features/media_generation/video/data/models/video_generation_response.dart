...
import '../../../../../core/utils/model_mapper_helper.dart';
...
class VideoResult {
  ...
  VideoResult({required this.url, this.coverImageUrl});
...
class AliyunVideoUsage {
  ...
  AliyunVideoUsage(this.videoCount, this.videoDuration, this.videoRatio);
...
class SiliconflowVideoStatusResult {
  ...
  SiliconflowVideoStatusResult(this.seed, this.timings, this.videos);
