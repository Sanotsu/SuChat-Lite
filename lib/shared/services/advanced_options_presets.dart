...
import '../widgets/chat_advanced_options/advanced_options_panel.dart';
...
class AdvancedOptionsManager {
  ...
  static final Map<AOEnum, AdvancedOption> aoCommonMap = {
    ...
    AOEnum.response_format: AdvancedOption(
      ...
      items: [OptionItem('文本', 'text'), OptionItem('JSON对象', 'json_object')],
    ),
  };
  ...
  static final Map<LLModelType, List<AdvancedOption>> _commonTypeOptions = {
    ...
    LLModelType.image: [
      ...
      AdvancedOption(
        ...
        items: [OptionItem('standard', '标准'), OptionItem('hd', '高清')],
      ),
    ],
  ...
  _platformOptions = {
    ...
    ApiPlatform.zhipu: {
      LLModelType.cc: [aoSpecialMap[AOEnum.do_sample]!],
      LLModelType.vision: [aoSpecialMap[AOEnum.do_sample]!],
    },
  };
  ...
  static final Map<ApiPlatform, Map<String, String?>> _parameterMappings = {
    ...
    ApiPlatform.tencent: {'max_tokens': 'max_completion_tokens'},
...
class ObjectConfig {
  ...
  const ObjectConfig({required this.type, required this.key});
}
